...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    render(
        rsx! {<div class="flex bg-black w-64">
            "hello"
        <div>"world"</div></div>},
        &mut commands,
        root,
...
const REM: f32 = 16.0;
const PIXEL_MULTIPLIER: f32 = REM / 4.0;
        ...
        for name in names.split(" ") {
            match name {
                ...
                | "w-96" => {
                    ...
                    style.width = Val::Px(value * PIXEL_MULTIPLIER)
                }
                ...
                | "h-96" => {
                    ...
                    style.height = Val::Px(value * PIXEL_MULTIPLIER);
                }
                ...
                | "p-96" => {
                    ...
                    style.padding =
                        UiRect::all(Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0)))
                }
                ...
                | "pt-72" | "pt-80" | "pt-96" => {
                    ...
                    style.padding.top = Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0))
                }
                ...
                | "pr-72" | "pr-80" | "pr-96" => {
                    ...
                    style.padding.right =
                        Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0))
                }
                ...
                | "pl-72" | "pl-80" | "pl-96" => {
                    ...
                    style.padding.left = Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0))
                }
                ...
                | "px-72" | "px-80" | "px-96" => {
                    ...
                    let value = Val::Px(number.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0));
                ...
                | "mt-72" | "mt-80" | "mt-96" => {
                    ...
                    style.margin.top = Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0))
                }
                ...
                | "mr-72" | "mr-80" | "mr-96" => {
                    ...
                    style.margin.right = Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0))
                }
                ...
                | "ml-72" | "ml-80" | "ml-96" => {
                    ...
                    style.margin.left = Val::Px(value.map(|v| v * PIXEL_MULTIPLIER).unwrap_or(1.0))
                }
